  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn("rounded-md flex-col w-full h-full p-3 items-center justify-center text-center absolute bg-gray-100/70 dark:bg-neutral-950 text-lg font-mono", {
